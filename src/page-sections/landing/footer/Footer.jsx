...
export default function Footer() {
  return <footer>
      ...
      <Container>
        <TicketWrapper>
          ...
          <FlexBox justifyContent="center" alignItems="center" gap={2}>
            ...
            <Button target="_blank" LinkComponent="a" variant="outlined" href="mailto:support@futeur.ai?subject=Candidate React Query">
              Send an email
            </Button>
          </FlexBox>
        </TicketWrapper>
      ...
      <Paragraph fontSize={16} textAlign="center" py={6}>
        Copyright ©{' '}
        <Box component="a" href="https://www.futeur.com" target="_blank">
        Futeur AI
        </Box>
        . All rights reserved
      </Paragraph>
